    ...
    dispatch_block_t dismissCompletionBlock = ^{
        ...
        if ([mediaType isEqualToString:(NSString *)kUTTypeImage]) { // PHOTOS
            ...
            if (imageURL) {
                ...
                [pickedAsset requestContentEditingInputWithOptions:nil
                                                 completionHandler:^(PHContentEditingInput * _Nullable contentEditingInput, NSDictionary * _Nonnull info) {
                                                     NSString *path = contentEditingInput.fullSizeImageURL.path;
                                                     
                                                     NSURL *fileURL = [NSURL fileURLWithPath:path];
                                                     [self.response setObject:path forKey:@"uri"];
                                                    ...
                                                    [self.response setObject:[NSNumber numberWithInt:fileSize] forKey:@"fileSize"];
